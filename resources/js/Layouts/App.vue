<template>
        <div class="min-h-screen bg-gray-100">
            <header class="bg-white w-full shadow z-40">
                <div class="max-w-7xl mx-auto px-2 z-40">
            ...
            <div class="w-full flex z-30 overflow-hidden">
                <nav class="bg-white shadow w-full md:w-auto md:max-w-max fixed sm:static top-16 left-0 overflow-hidden">
                    <!-- Navigation Menu -->
                    <div :class="{'block sm:hidden': showingNavigationDropdown, 'hidden sm:block': ! showingNavigationDropdown}" class="h-screen -mt-16 pt-16 overflow-auto">
                        ...
                        <NavLink :href="route('projects.index')" :active="route().current('projects.show')">
                            Projects
                        </NavLink>
                    </div>
                </nav>
